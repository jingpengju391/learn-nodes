...
###### Tip 在 [入口起点](https://webpack.docschina.org/concepts/entry-points) 章节可以了解更多信息。
...
`output` 属性还有 [更多可配置的特性](https://webpack.docschina.org/configuration/output)，如果你想要了解更多关于 `output` 属性的概念，可以通过阅读 [输出章节](https://webpack.docschina.org/concepts/output) 来了解更多。
